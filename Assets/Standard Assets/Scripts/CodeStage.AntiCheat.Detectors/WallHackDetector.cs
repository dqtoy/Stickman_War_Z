...
namespace CodeStage.AntiCheat.Detectors
{
	...
	{
		private sealed class _InitDetector_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
		{
			internal WallHackDetector _this;
			...
			public _InitDetector_c__Iterator0()
			{
			}
			...
			public bool MoveNext()
			{
				...
				{
				case 0u:
					this._current = this._this.waitForEndOfFrame;
					if (!this._disposing)
					{
						this._PC = 1;
					}
					return true;
				case 1u:
					this._this.UpdateServiceContainer();
					if (this._this.checkRigidbody)
					{
						this._this.StartRigidModule();
					}
					if (this._this.checkController)
					{
						this._this.StartControllerModule();
					}
					if (this._this.checkWireframe)
					{
						this._this.StartWireframeModule();
					}
					if (this._this.checkRaycast)
					{
						this._this.StartRaycastModule();
					}
					this._PC = -1;
					break;
				}
		...
		private sealed class _CaptureFrame_c__Iterator1 : IEnumerator, IDisposable, IEnumerator<object>
		{
			internal RenderTexture _previousActive___0;

			internal bool _detected___0;
			...
			public _CaptureFrame_c__Iterator1()
			{
			}
			...
			public bool MoveNext()
			{
				...
				{
				case 0u:
					this._this.wfCamera.enabled = true;
					this._current = this._this.waitForEndOfFrame;
					if (!this._disposing)
					{
						this._PC = 1;
					...
					return true;
				case 1u:
					this._this.foregroundRenderer.enabled = true;
					this._this.backgroundRenderer.enabled = true;
					this._previousActive___0 = RenderTexture.active;
					RenderTexture.active = this._this.renderTexture;
					this._this.wfCamera.Render();
					this._this.foregroundRenderer.enabled = false;
					this._this.backgroundRenderer.enabled = false;
					break;
				case 2u:
					break;
				case 3u:
				...
				if (!this._this.renderTexture.IsCreated())
				{
					this._current = this._this.waitForEndOfFrame;
					if (!this._disposing)
					{
				...
				this._this.targetTexture.ReadPixels(new Rect(0f, 0f, 4f, 4f), 0, 0, false);
				this._this.targetTexture.Apply();
				RenderTexture.active = this._previousActive___0;
				if (!(this._this.wfCamera == null))
				{
					this._this.wfCamera.enabled = false;
					this._detected___0 = (this._this.targetTexture.GetPixel(0, 3) != this._this.wfColor1 || this._this.targetTexture.GetPixel(0, 1) != this._this.wfColor2 || this._this.targetTexture.GetPixel(3, 3) != this._this.wfColor1 || this._this.targetTexture.GetPixel(3, 1) != this._this.wfColor2 || this._this.targetTexture.GetPixel(1, 3) != this._this.wfColor1 || this._this.targetTexture.GetPixel(2, 3) != this._this.wfColor1 || this._this.targetTexture.GetPixel(1, 1) != this._this.wfColor2 || this._this.targetTexture.GetPixel(2, 1) != this._this.wfColor2);
					if (!this._detected___0)
					{
						if (this._this.wireframeDetections > 0)
						{
							this._this.wireframeDetections = 0;
						}
					}
					else
					{
						WallHackDetector expr_2EF = this._this;
						expr_2EF.wireframeDetections += 1;
						this._this.wireframeDetected = this._this.Detect();
					}
					this._current = null;
					if (!this._disposing)
					{
		...
		{
			WallHackDetector._InitDetector_c__Iterator0 _InitDetector_c__Iterator = new WallHackDetector._InitDetector_c__Iterator0();
			_InitDetector_c__Iterator._this = this;
			return _InitDetector_c__Iterator;
		}
		...
		{
			WallHackDetector._CaptureFrame_c__Iterator1 _CaptureFrame_c__Iterator = new WallHackDetector._CaptureFrame_c__Iterator1();
			_CaptureFrame_c__Iterator._this = this;
			return _CaptureFrame_c__Iterator;
		}
