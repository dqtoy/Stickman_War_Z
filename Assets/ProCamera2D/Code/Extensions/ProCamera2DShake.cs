...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DShake : BasePC2D
    {
        ...
        {
            this.Shake(preset.Duration, preset.Strength, preset.Vibrato, preset.Randomness, (!preset.UseRandomInitialAngle) ? preset.InitialAngle : -1f, preset.Rotation, preset.Smoothness, preset.IgnoreTimeScale);
        }
