...
namespace UnityEngine.UI.Extensions
{
    ...
    public class VerticalScrollSnap : ScrollSnapBase, IEndDragHandler
    {
        ...
        void Update()
        {
            ...
            {
                _screensContainer.localPosition = Vector3.Lerp(_screensContainer.localPosition, new Vector3(0,_lerp_target.y,_lerp_target.z), transitionSpeed * Time.deltaTime);
